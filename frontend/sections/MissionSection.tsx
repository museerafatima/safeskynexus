...
export default function MissionSection() {
  return (
    <section className="bg-gray-50/60 max-w-full">
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20 overflow-hidden">
        <div className="grid lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-14 items-center">
          {/* Left: image collage */}
          <Reveal className="relative w-full max-w-xs sm:max-w-sm md:max-w-md mx-auto lg:mx-0 aspect-4/3 group">
            ...
            <div className="absolute -bottom-4 -right-4 sm:-bottom-6 sm:-right-6 w-[38%] sm:w-2/5 aspect-square bg-white p-1.5 sm:p-2 rounded-lg sm:rounded-xl shadow-xl z-20 transition-transform duration-300 hover:scale-105">
          ...
          {/* Right: text */}
          <Reveal delay={150} className="lg:pl-4 text-center lg:text-left mt-4 lg:mt-0">
            ...
            <ul className="space-y-2 text-left max-w-xl mx-auto lg:mx-0 inline-block lg:block">
              {missionPoints.map((point) => (
                <li
                  key={point}
                  className="text-navy text-sm sm:text-base flex items-start gap-2 transition-colors duration-200 hover:text-orange"
                >
