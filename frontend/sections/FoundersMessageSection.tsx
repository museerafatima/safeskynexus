...
export default function FoundersMessageSection() {
  return (
    <section className="bg-gray-50/60">
      <div className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
        <Reveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[220px_1fr] xl:grid-cols-[280px_1fr] gap-8 sm:gap-10 items-start">
          ...
          <Reveal className="flex justify-center lg:justify-start">
            <div className="w-40 h-40 sm:w-52 sm:h-52 lg:w-56 lg:h-56 xl:w-64 xl:h-64 rounded-full bg-navy overflow-hidden flex items-end justify-center transition-transform duration-300 hover:scale-105">
              <Image
                src={founderPhoto}
          ...
          <Reveal
            delay={150}
            className="text-body text-sm sm:text-base leading-relaxed text-left lg:text-justify space-y-4 max-w-2xl mx-auto lg:mx-0"
          >
            <p>
