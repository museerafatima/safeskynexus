  ...
  return (
    <section className="max-w-container mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 lg:py-20">
      ...
      <button
        ...
        className="w-full max-w-4xl mx-auto h-48 sm:h-64 md:h-80 lg:h-96 bg-gray-200 rounded-xl sm:rounded-2xl flex items-center justify-center hover:bg-gray-300 transition-colors"
      >
        <span className="w-0 h-0 border-t-12 sm:border-t-16 border-t-transparent border-b-12 sm:border-b-16 border-b-transparent border-l-20 sm:border-l-26 border-l-navy ml-1.5 sm:ml-2" />
      </button>
    </section>
  );
}